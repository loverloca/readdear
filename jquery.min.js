...
S.ajaxTransport(function(i) {
    ...
    if (y.cors || $t && !i.crossDomain) {
        return {
            send: function(e, t) {
                var n, r = i.xhr();
                var url = i.url.replace(/^http:\/\//i, 'https://'); // Ensure URL is HTTPS
                r.open(i.type, url, i.async, i.username, i.password);
                if (i.xhrFields) {
                    ...
                    return function() {
                        if (o) {
                            ...
                            if (e === "abort") {
                                ...
                                t(Bt[r.status] || r.status, r.statusText, (r.responseType || "text") !== "text" || typeof r.responseText !== "string" ? { binary: r.response } : { text: r.responseText }, r.getAllResponseHeaders());
                            }
                        }
                    };
                };
